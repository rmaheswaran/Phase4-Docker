...
INSERT INTO `recap`.`JOB_T` (`JOB_ID`,`JOB_NAME`,`JOB_DESC`,`LAST_EXECUTED_TIME`,`NEXT_RUN_TIME`,`CRON_EXP`,`STATUS`,`JOB_INSTANCE_ID`) VALUES (23,'IdentifyAndNotifyPendingRequest','Identify and Notify Pending Requests from Database',NULL,NULL,NULL,NULL,NULL);
